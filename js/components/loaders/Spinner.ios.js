...
export default class SpinnerNB extends NativeBaseComponent {
  ...
  render () {
    return (
      <ActivityIndicatorIOS {...this.prepareRootProps()}
        color={this.props.color ? this.props.color : this.props.inverse ? this.getTheme().inverseSpinnerColor : this.getTheme().defaultSpinnerColor} size={this.props.size ? this.props.size : 'large'} />
    )
  }
